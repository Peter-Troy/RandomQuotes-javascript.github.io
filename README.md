...
Created an HTML structure with a <h1> heading, a <div> container for the quote display, an input field, and buttons.
CSS Styling:

Set basic styling for the <h1> heading, quote text, input field, and buttons.
